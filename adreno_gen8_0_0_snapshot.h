...
static struct gen8_shader_block gen8_0_0_shader_blocks[] = {
	{ TP0_TMO_DATA, 0x0200, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ TP0_SMO_DATA, 0x0080, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ TP0_MIPMAP_BASE_DATA, 0x0080, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA_3, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA_1, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_0_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_1_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_2_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_3_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_4_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_5_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_6_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_7_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_CB_RAM, 0x0390, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_13_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_14_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_TAG, 0x0100, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA_2, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_TMO_TAG, 0x0080, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_SMO_TAG, 0x0080, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_STATE_DATA, 0x0040, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_HWAVE_RAM, 0x0200, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_L0_INST_BUF, 0x0080, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_8_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_9_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_10_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_11_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_12_DATA, 0x0800, 2, 1, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
