...
static struct gen8_shader_block gen8_0_0_shader_blocks[] = {
	{ TP0_TMO_DATA, 0x0200, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ TP0_SMO_DATA, 0x0080, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ TP0_MIPMAP_BASE_DATA, 0x0080, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA_3, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA_1, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_0_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_1_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_2_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_3_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_4_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_5_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_6_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_7_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_CB_RAM, 0x0390, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_13_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_14_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_TAG, 0x0100, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_INST_DATA_2, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_TMO_TAG, 0x0080, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_SMO_TAG, 0x0080, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_STATE_DATA, 0x0040, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_HWAVE_RAM, 0x0100, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_L0_INST_BUF, 0x0080, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_8_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_9_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_10_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_11_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
	{ SP_LB_12_DATA, 0x0800, 2, 2, PIPE_BR, USPTP, MAX_PHYSICAL_SLICES, 1},
...
static struct gen8_sptp_cluster_registers gen8_0_0_sptp_clusters[] = {
	...
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX0_3D_CVS_REG, PIPE_BR, 0, SP_TOP,
	...
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX0_3D_CVS_REG, PIPE_BR, 0, USPTP,
	...
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX0_3D_CVS_REG, PIPE_BV, 0, HLSQ_STATE,
	...
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX0_3D_CVS_REG, PIPE_BV, 0, SP_TOP,
	...
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX0_3D_CVS_REG, PIPE_BV, 0, USPTP,
	...
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_vs_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BR, 1, SP_TOP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BR, 1, SP_TOP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_vs_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BR, 1, USPTP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BV, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BV, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BV, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_bv_cluster_sp_vs_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BV, 1, SP_TOP,
		gen8_0_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BV, 1, SP_TOP,
		gen8_0_0_sp_slice_pipe_bv_cluster_sp_vs_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, SP_CTX1_3D_CVS_REG, PIPE_BV, 1, USPTP,
		gen8_0_0_sp_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_BR, 0, HLSQ_STATE,
	...
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_BR, 0, HLSQ_DP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_BR, 0, SP_TOP,
	...
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_BR, 0, USPTP,
	...
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_STATE,
	...
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_STATE,
		...
		0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_LPAC, 0, HLSQ_DP,
		gen8_0_0_sp_slice_pipe_lpac_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_LPAC, 0, SP_TOP,
	...
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX0_3D_CPS_REG, PIPE_LPAC, 0, USPTP,
	...
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, HLSQ_STATE,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_state_shared_const_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, HLSQ_DP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, SP_TOP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, SP_TOP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX1_3D_CPS_REG, PIPE_BR, 1, USPTP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX2_3D_CPS_REG, PIPE_BR, 2, HLSQ_DP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX2_3D_CPS_REG, PIPE_BR, 2, SP_TOP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX3_3D_CPS_REG, PIPE_BR, 3, HLSQ_DP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_hlsq_dp_registers, 0xa800},
	{ CLUSTER_SP_PS, SLICE, 2, 2, SP_CTX3_3D_CPS_REG, PIPE_BR, 3, SP_TOP,
		gen8_0_0_sp_slice_pipe_br_cluster_sp_ps_sp_top_cctx_registers, 0xa800},
	{ CLUSTER_SP_VS, SLICE, 2, 2, TP0_CTX0_3D_CVS_REG, PIPE_BR, 0, USPTP,
		gen8_0_0_tpl1_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_VS, SLICE, 2, 2, TP0_CTX0_3D_CVS_REG, PIPE_BV, 0, USPTP,
		gen8_0_0_tpl1_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_VS, SLICE, 2, 2, TP0_CTX1_3D_CVS_REG, PIPE_BR, 1, USPTP,
		gen8_0_0_tpl1_slice_pipe_br_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_VS, SLICE, 2, 2, TP0_CTX1_3D_CVS_REG, PIPE_BV, 1, USPTP,
		gen8_0_0_tpl1_slice_pipe_bv_cluster_sp_vs_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 2, TP0_CTX0_3D_CPS_REG, PIPE_BR, 0, USPTP,
		gen8_0_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 2, TP0_CTX0_3D_CPS_REG, PIPE_LPAC, 0, USPTP,
		gen8_0_0_tpl1_slice_pipe_lpac_cluster_sp_ps_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 2, TP0_CTX1_3D_CPS_REG, PIPE_BR, 1, USPTP,
		gen8_0_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 2, TP0_CTX2_3D_CPS_REG, PIPE_BR, 2, USPTP,
		gen8_0_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xb000},
	{ CLUSTER_SP_PS, SLICE, 2, 2, TP0_CTX3_3D_CPS_REG, PIPE_BR, 3, USPTP,
		gen8_0_0_tpl1_slice_pipe_br_cluster_sp_ps_usptp_registers, 0xb000},
};
